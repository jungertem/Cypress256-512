...
namespace Cypress
{
    class Cypress512
    {
        public ulong[] OpenText { get; set; }
        public ulong[] Key { get; set; }
        public List<ulong[]> _roundKeys;
        ...
        public Cypress512(bool isCypress256)
        {
            ...
            _roundKeys = new List<UInt64[]>();

            Init();
        }


        public void Arx(ulong[] block)
        {
            var p0 = block[0];
            var p1 = block[1];
            var p2 = block[2];
        ...
        {
            ulong[] one = { 1, 1, 1, 1 };
            ulong[] tmv = { 0x000F000F, 0x000F000F, 0x000F000F, 0x000F000F };
        ...
        public ulong[] EncryptBlock(ulong[] plainText)
        {
        ...
        public ulong[] FullEncrypt(List<ulong> message)
        {
            var encryptedMessage = new List<ulong>();
